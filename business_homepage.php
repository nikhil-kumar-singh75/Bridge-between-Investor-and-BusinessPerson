<?php
	if(isset($_POST['username']))
	{
		...
		$sql="SELECT * FROM `bridge`.`businesslogin`";
		...
		if($num>0)
		{
			while($row=mysqli_fetch_assoc($res))
			{
				...
				{
					// echo "<center><h1>Welcome to Business person Homepage</h1></center><br>";
					// echo "Enter Your business Idea : <textarea></textarea>";
					// break;
...
<head>
	...
	<title>Business Person Homepage</title>
...
<body>
 ...
 -->      </ul>
  ...
  <div class="div1 px-4 py-5 my-5 text-center">
    ...
    <h1 class="display-5 fw-bold">Welcome to Business Homepage</h1>
    <div class="col-lg-6 mx-auto">
	  ...
	  <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
		  <form action="upload.php" method="post">
		  	<button class="btn1 btn btn-primary btn-lg px-4 gap-3">Upload Your business idea</button>
		  </form>
...
<!-- <br> <br> <br>
<center><h1>Welcome to Business Person homepage</h1></center>
<br> <br> <br> <br> <br> <br>


<form action="upload.php" methos="post">

<center><button class="sign w-45 btn btn-lg btn-primary">Upload Your business idea</button></center>
