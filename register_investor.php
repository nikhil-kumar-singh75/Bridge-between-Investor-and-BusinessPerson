<?php
  ...
  $pwd = $_POST['pwd'];
    ...
    $sql = "INSERT INTO `bridge`.`investorlogin` (`comp_name`, `email`, `phone`,`pwd`) VALUES('$comp_name', '$username', '$phone','$pwd');";
...
<body>
  ...
  <form action="register_investor.php" method="post">
    ...
    <button name="submit" class="reg w-100 btn btn-lg btn-primary">Register</button>

    </form>
    <form action="login_investor.php" method="post">
    <button class="sign w-100 btn btn-lg btn-success">Sign in</button>
